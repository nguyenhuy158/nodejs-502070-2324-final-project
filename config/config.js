...
module.exports = {
    port: process.env.PORT || 3000, database: {
    ...
    }, jwtSecret: process.env.JWT_SECRET || "your-secret-key", cookieSessionConfig: cookieSession({
        name: process.env.COOKIE_SESSION_NAME,
        keys: [process.env.COOKIE_SESSION_SECRET],
        httpOnly: true,
    }), cookieOptions: {
        maxAge: 20 * 60 * 1000, httpOnly: true, secure: true, sameSite: "None",
    }, staticOptions: {
        dotfiles: "ignore",
        etag: false,
